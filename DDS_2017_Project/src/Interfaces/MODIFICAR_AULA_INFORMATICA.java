 ...
 * @author rodri
 */
public class MODIFICAR_AULA_INFORMATICA extends javax.swing.JFrame {

    /**
     * Creates new form MODIFICAR_AULA_INFORMATICA
     */
    public MODIFICAR_AULA_INFORMATICA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccion de cantidad" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MODIFICAR_AULA_INFORMATICA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MODIFICAR_AULA_INFORMATICA().setVisible(true);
            }
        });
    }
